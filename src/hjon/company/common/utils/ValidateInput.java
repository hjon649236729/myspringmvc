...
//    public static List<String> autoValidate(columnInfo column,Object input){
//    	if(input.equals("")){
//   		return null;
//    	}
...
//    			pass=false;
//    			warnings.add(column.getExplain()+":不可为空!");
//    		}
//    	}
//    	//判断长度
//    	if(column.getLength()!=0){
//    		if((str.length()<0)||(str.length()>=column.getLength())){
//    			pass=false;
//    			warnings.add(column.getExplain()+":数据输入长度错误!");
//    		}
//    	}
//    	//判断类型 类型只能为一种
//    	
//    	
//    	//验证是否为英文字符串
//    	if(column.getType().equals("enString")){
//    		if(!isValidEnglish(str)){
//    			pass=false;
//    			warnings.add(column.getExplain()+":数据应为英文字符!");
//    			
//    		}
//    	}
//    	//验证是否为中文字符串
//    	if(column.getType().equals("cnString")){
//    		if(!isCN(str)){
//    			pass=false;
//    			warnings.add(column.getExplain()+":数据应为中文字符!");
//    			
//    		}
//    	}
//    	//验证是否为正整数
...
//    			pass=false;
//    			warnings.add(column.getExplain()+":数据应为正整数!");
//    			
//    		}
//    	}
//    	//依次添加需要规则.............
