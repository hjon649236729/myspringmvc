...
public class Test1 {
	...
	public static String TRIGGER_NAME = "动态任务触发器1_TestJob1";
	public static String JOB_GROUP_NAME = "动态任务_JOB_GROUP1_TestJob1";
	public static String TRIGGER_GROUP_NAME = "动态任务_trigger_GROUP1_TestJob1";
	...
	public static void main(String[] args) {
		try {
			...
			QuartzManager.addJob(JOB_NAME, JOB_GROUP_NAME, TRIGGER_NAME,
					TRIGGER_GROUP_NAME,
					Class.forName("com.hjon.modules.quartz.job.TestJob2"),
					"0/1 * * * * ?");*/
