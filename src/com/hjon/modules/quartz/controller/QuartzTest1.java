...
public class QuartzTest1 {
	...
	private static String JOB_DETAIL_NAME = "JOB_DETAIL_NAME1";
	private static String TRIGGER_NAME_NAME = "TRIGGER_NAME_NAME1";
	...
	public static void startSchedule() {
		try {
			JobKey jobkey = JobKey.jobKey(JOB_DETAIL_NAME, JOB_GROUP_NAME);
			...
			JobDetail jobDetail = JobBuilder.newJob(AuthJob.class)
					...
					.build();
			// 2、创建Trigger
			TriggerKey triggerKey = TriggerKey.triggerKey(JOB_DETAIL_NAME,
					JOB_GROUP_NAME);
			...
			Trigger trigger = TriggerBuilder.newTrigger().forJob(jobDetail)
					.withIdentity(triggerKey).startNow().withSchedule(builder)
					.build();
			// 3、创建Scheduler
