...
/**
 * WfProcesssteplink entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "wf_processsteplink", catalog = "springmvc")
public class ProcessStepLink implements java.io.Serializable {
