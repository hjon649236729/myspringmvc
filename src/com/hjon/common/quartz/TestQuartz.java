...
import com.hjon.modules.auth.job.AuthJob2;
/**
 * 任务调度公共类
 * @remark
 * @author feizi
...
public class TestQuartz {
    ...
    private static Logger log = LoggerFactory.getLogger(TestQuartz.class);//日志
    ...
    public static void main(String[] args) {
        try {
            //添加第一个任务  每隔10秒执行一次
            TestQuartz.addJob("job1", "trigger1", AuthJob.class, 2);

            //添加第二个任务  每隔20秒执行一次
            TestQuartz.addJob("Job2", "trigger2", AuthJob2.class, 5);
