...
<script
	src="${contextPath}/Scripts/bootstrapvalidator/dist/js/bootstrapValidator.min.js"></script>
<script
	src="${contextPath}/Scripts/bootstrapvalidator/dist/js/language/zh_CN.js"></script>
<script src="${contextPath}/Scripts/myscripts/js/page.js"></script>