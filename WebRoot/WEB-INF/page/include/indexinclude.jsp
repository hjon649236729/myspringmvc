...
<link href="${contextPath}/Scripts/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
<link
	href="${contextPath}/Scripts/bootstrap/css/bootstrapValidator.min.css"
	rel="stylesheet">
...
<script
	src="${contextPath}/Scripts/bootstrap/js/bootstrapValidator.min.js"></script>
