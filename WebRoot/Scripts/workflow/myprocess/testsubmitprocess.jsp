...
<script type="text/javascript">
    function  submitProcess(){
        $("#form").stk_submit("submitProcess",function(result){
...
<ui:form id="form" clazz="com.sinitek.sirm.busin.workflow.support.action.WorkflowActionTest2" method="submitProcess">
    <input id="syscode" name="syscode" value="250" type="hidden"/>
    <input id="exampleid" name="exampleid" value="${param.exampleid}" type="hidden"/>
    <input id="examplestepid" name="examplestepid" value="${param.examplestepid}" type="hidden"/>
