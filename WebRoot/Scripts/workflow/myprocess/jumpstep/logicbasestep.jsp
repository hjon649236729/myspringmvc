...
<sirm:body>
    <ui:form id="processform" clazz="com.sinitek.sirm.web.workflow.myprocess.jumpstep.LogicStepAction"
        ...
        <div align="center" style="padding-top:5px;">
            通过步骤选择：
            <sirmwf:logicsteplist var="steplist1" type="3" mode="1" exampleownerid="${exampleownerid}"/>
        ...
        <div align="center" style="padding-top:5px;">
            驳回步骤选择：
            <sirmwf:logicsteplist var="steplist2" type="3" mode="2" even="1" exampleownerid="${exampleownerid}"/>
