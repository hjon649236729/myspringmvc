...
%>
<sirm:body>
    <ui:form id="processform" clazz="com.sinitek.sirm.web.workflow.myprocess.jumpstep.PhysicalStepAction"
             method="base">
        ...
        <div align="center" style="padding-top:5px;">
            通过步骤选择：
            <sirmwf:physicalsteplist var="steplist1" type="3" mode="1" exampleownerid="${exampleownerid}"/>
            <ui:select name="processstepid1" id="processstepid1" list="#attr.steplist1"
                       headerKey="0" headerValue="不指定步骤"></ui:select>
            <ui:button text="通过任务">
                <event:onclick>
                    $("#condition").stk_val(1);
                    $("#processform").stk_submit("base", function(result) {
                    if (result != null) {
                    stk.alert(result);
                    return;
                    }
        ...
        <div align="center" style="padding-top:5px;">
            驳回步骤选择：
            <sirmwf:physicalsteplist var="steplist2" type="3" mode="2" even="1" exampleownerid="${exampleownerid}"/>
