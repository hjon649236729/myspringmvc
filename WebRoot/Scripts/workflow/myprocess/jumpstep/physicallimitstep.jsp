...
<sirm:body>
    <ui:form id="processform" clazz="com.sinitek.sirm.web.workflow.myprocess.jumpstep.PhysicalStepAction"
        ...
        <div align="center" style="padding-top:5px;">
            通过步骤选择：
            <sirmwf:physicalsteplist var="steplist1" type="3" mode="3" exampleownerid="${exampleownerid}"/>
        ...
        <div align="center" style="padding-top:5px;">
            驳回步骤选择：
            <sirmwf:physicalsteplist var="steplist2" type="3" mode="4" even="1" exampleownerid="${exampleownerid}"/>
