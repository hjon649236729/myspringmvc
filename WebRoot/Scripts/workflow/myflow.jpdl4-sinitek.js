...
//    });
    ...
    $.extend(true, myflow.config.tools.states, {
        'start': {
            ...
            name: {text: '<<start>>'},
            text: {text: '开始步骤'},
            img: {src: '/Scripts/workflow/img/48/start_event_empty.png', width: 48, height: 48},
//            attr: {width: 50, heigth: 50 , r: 25, fill: "#7fd924", stroke: "#AAA", "stroke-width": 1},
        ...
        'end': {
            ...
            name: {text: '<<end>>'},
            text: {text: '结束步骤'},
            img: {src: '/Scripts/workflow/img/48/end_event_terminate.png', width: 48, height: 48},
            attr: {width: 50, heigth: 50 },
            props: {
                stepname: {name: 'stepname', label: '步骤名称', value: '', editor: function () {
                    return new myflow.editors.stepnameEditor();
        ...
        'submit': {
            ...
            name: {text: '<<submit>>'},
            text: {text: '提交步骤'},
            img: {src: '/Scripts/workflow/img/48/task_yellow.png', width: 48, height: 48},
        ...
        'judge': {
            ...
            name: {text: '<<judge>>'},
            text: {text: '处理步骤'},
            img: {src: '/Scripts/workflow/img/48/task_empty.png', width: 48, height: 48},
            props: {
                stepname: {name: 'stepname', label: '步骤名称', value: '', editor: function () {
                    return new myflow.editors.stepnameEditor();
                }},
        ...
        'task': {
            ...
            name: {text: '<<task>>'},
            text: {text: '任务'},
            img: {src: '/Scripts/workflow/img/48/task_java.png', width: 48, height: 48},
            attr: {width: 50, heigth: 50 },
            props: {
        ...
        'end-cancel': {
            ...
            text: {text: '取消'},
            img: {src: '/Scripts/workflow/img/48/end_event_cancel.png', width: 48, height: 48},
            attr: {width: 50, heigth: 50 },
            props: {
                text: {name: 'text', label: '显示', value: '', editor: function () {
                    return new myflow.editors.textEditor();
        ...
        'end-error': {
            ...
            name: {text: '<<end-error>>'},
            text: {text: '错误1'},
            img: {src: '/Scripts/workflow/img/48/end_event_error.png', width: 48, height: 48},
            attr: {width: 50, heigth: 50 },
            props: {
        ...
        'fork': {
            ...
            name: {text: '<<fork>>'},
            text: {text: '分支'},
            img: {src: '/Scripts/workflow/img/48/gateway_parallel.png', width: 48, height: 48},
            attr: {width: 50, heigth: 50 },
            props: {
                text: {name: 'text', label: '显示', value: '', editor: function () {
                    return new myflow.editors.textEditor();
