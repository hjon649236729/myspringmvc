        ...
        <layout:tabs id="demo" width="100%" tabWidth="110px">
            <layout:tab title="未完成" id="unfinishtab">
                <form id="unfinishform">
                    ...
                    <br>
                    <ui:table id="unfinishtable" queryForm="unfinishform" nowrap="true" allowInit="false" actionClass="com.sinitek.sirm.web.workflow.applicate.ManagerProcessAction"
                              pageSize="10">
            ...
            <layout:tab title="已完成" id="finishedtab">
                <form id="finishedform">
                    ...
                    <ui:table id="finishedtable" queryForm="finishedform" nowrap="true" allowInit="false"
                              actionClass="com.sinitek.sirm.web.workflow.applicate.ManagerProcessHistoryAction" pageSize="10">
                        ...
                        <ui:colDate property="starttime" title="开始时间" width="120px" format="yyyy-MM-dd HH:mm" allowSort="false"></ui:colDate>
                        <ui:colDate property="endtime" title="结束时间" width="120px" format="yyyy-MM-dd HH:mm" allowSort="false"></ui:colDate>
                    </ui:table>
                </form>
            </layout:tab>
