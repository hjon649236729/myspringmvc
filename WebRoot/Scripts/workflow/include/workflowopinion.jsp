...
<%
    ...
    List<Map> _opinionlist = ShowWorkflowOpinionAction.getworkflowopinion(_exampleid, _sort, _type);
    ...
    <table width="${workflowwidth}">
        ...
        <c:forEach items="${workflowopinionlist}" var="workflowopinion">
            <tr bgcolor="${workflowbgcolor}">
                <td width="200px">
                    <B>${workflowbase}人：${workflowopinion.ownername}&nbsp${workflowopinion.statusvalue}</B></td>
                <td></td>
                <td width="240px"><B>${workflowbase}时间：${workflowopinion.approvetimeshow}</B></td>
            </tr>
                <tr>
                    <td colspan="3">
                        <ui:textarea rows="3" width="100%" readOnly="true"
                                     defaultValue="${workflowopinion.approveopinion}"></ui:textarea>
                    </td>
                </tr>
        </c:forEach>
    </table>
