...
<%
    ...
    int _type = NumberTool.safeToInteger(request.getParameter("type"),2);
    List<Map> _opinionlist = ShowWorkflowOpinionAction.getworkflowsopinion(_exampleid, _sort, _type);
