...
//            alert(uploadFile.stk_val());
            if(uploadFile.stk_val()==''){
                ...
                if(!allowSubmit){
                    $('#messageDiv').stk_html('只允许上传xml类型的文件');
                }else{
                    $('#processform').submit();
...
<sirm:body>
    ...
    <form id="processform" action="${contextPath}/workflow/configurate/importprocess.action" method="post" enctype="multipart/form-data">
