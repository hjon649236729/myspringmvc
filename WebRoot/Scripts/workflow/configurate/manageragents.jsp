...
<form name="searchform" id="searchform">
    <table class="search-params-bar">
        <tr>
            <td class="tit"><label>被代理人</label></td>
            <td class="tit">
                <org:SelectOrg prefix="viewer" multi="false" mode="user" width="120px"/>
            </td>
            <td class="tit">
            ...
            <td class="tit">
                <div id="viewers" name="viewers" style="float:right;padding-right:40px;" align="left"></div>
                <input type="hidden" id="viewer" name="viewer"/>
            </td>
        </tr>
    </table>
</form>
<ui:table id="agentstable" nowrap="true" actionClass="com.sinitek.sirm.web.workflow.configurate.ManagerAgentsAction"
          pageSize="10" queryForm="searchform">
    ...
    <ui:col property="processtypevalue" title="流程类型" width="80px" align="left" allowSort="false"></ui:col>
    <ui:col property="processname" title="流程名称" width="100px" allowTip="true" align="left" allowSort="false"></ui:col>
    <ui:col property="stepname" title="步骤名称" width="100px" allowTip="true" align="left" allowSort="false"></ui:col>
    <ui:col property="ownername" title="被代理人" width="80px" allowTip="true" align="left" allowSort="false"/>
...
<layout:window id="addagentwindow" layout="row" title="添加流程代理" width="320px">
    <ui:form id="addagentform" clazz="com.sinitek.sirm.web.workflow.configurate.ManagerAgentsAction" method="saveprocessagent">
                ...
                <table class="stk-form-ui-st1">
                    <tr>
                        ...
                        <td class="bd" width="auto">
                            <ui:select id="processtype" name="processtype" list="#attr.processtypelist" listKey="key"
                    ...
                    <tr>
                        ...
                        <td class="bd" width="auto">
                            <ui:datefield id="starttime" name="starttime" type="date" endDate="endtime" width="90px"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="hd" width="100px">结束时间<em>*</em></td>
                        <td class="bd" width="auto">
                            <ui:datefield id="endtime" name="endtime" type="date" startDate="starttime" width="90px"/>
                        </td>
                    <tr>
                        <td class="hd" width="100px">被代理人<em>*</em></td>
                        <td class="bd" width="auto">
                            <org:SelectOrg prefix="agented" multi="false" mode="user" width="120px"/>
                        </td>
                    </tr>
                    <tr>
        ...
        <func:checkers>
            ...
            <func:checker target="_agented_candidateHidden" allowBlank="false" blankText="请选择被代理人"/>
...
<layout:window id="saveagentwindow" layout="row" title="编辑流程代理" width="320px">
    <ui:form id="saveagentform" clazz="com.sinitek.sirm.web.workflow.configurate.ManagerAgentsAction"
            ...
            <div>
                <table class="stk-form-ui-st1">
                    ...
                    <tr>
                        <td class="hd" width="100px">开始时间<em>*</em></td>
                        <td class="bd" width="auto">
                            <ui:datefield id="starttime2" name="starttime2" type="date" endDate="endtime2" width="90px"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="hd" width="100px">结束时间<em>*</em></td>
                        <td class="bd" width="auto">
                            <ui:datefield id="endtime2" name="endtime2" type="date" startDate="starttime2" width="90px"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="hd" width="100px">被代理人</td>
                        <td class="bd" width="auto">
                            <ui:label id="owner2"></ui:label>
                        </td>
                    </tr>
                    <tr>
                        <td class="hd" width="100px">代理人<em>*</em></td>
