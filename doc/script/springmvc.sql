...
CREATE TABLE `common_jobexecutelog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34630 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
-- ----------------------------
-- Table structure for common_sysmenu
-- ----------------------------
DROP TABLE IF EXISTS `common_sysmenu`;
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('DefaultQuartzScheduler', '测试定时任务1', '测试定时任务1', '测试定时任务1', '测试定时任务1', 'null########$$%%:com.hjon.modules.quartz.job.TestJob1########$$%%:0/2 * * * * ?', '1509211278000', '1509211276000', '5', 'PAUSED', 'CRON', '1508588123000', '0', null, '0', '');
INSERT INTO `qrtz_triggers` VALUES ('DefaultQuartzScheduler', '测试定时任务2', '测试定时任务2', '测试定时任务2', '测试定时任务2', '测试定时任务2########$$%%:com.hjon.modules.quartz.job.TestJob2########$$%%:0/5 * * * * ?', '1509211280000', '1509211275000', '5', 'PAUSED', 'CRON', '1508598707000', '0', null, '0', '');
